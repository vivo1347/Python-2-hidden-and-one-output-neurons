...
data = {
    ...
    "y": [0, 1, 1, 0]    # Output (AND of x1 and x2)
}
...
while cost>0.00001:
    ...
    for i, row in data.iterrows():
        ...
        sum_dcost_b11+= (-2*(y_i-a21)*a21*(1-a21)*1)
    cost =(1/N)*sum_cost
    w1 -=(lr*sum_dcost_dw1)
    w2-=(lr*sum_dcost_dw2)
    b1-=(lr*sum_dcost_b1)
    ...
    b11-=(lr*sum_dcost_b11)
    Epoch+=1
    print(f"Epoch: {Epoch}, cost: {cost}, w1: {w1},w2: {w2},b1: {b1}, b2: {b2}, w11: {w11}, b11{b11}")


X1_ask= 0
X2_ask= 1
z_ask11=(X1_ask*w1+b1)+(X2_ask*w2+b2)
a_ask11= (1/(1+math.exp(-z_ask11)))
z_ask21=a_ask11*w11+b11
